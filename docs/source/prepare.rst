...
FRASER_version                character  The FRASER version which will be used. Set to 'FRASER2' to use FRASER2 and the Intron Jaccard Index metric. All other values result in running FRASER with the metrics psi_5, psi_3 and theta.                     ``FRASER``
============================  =========  =================================================================================================================================================================================================================  ======
