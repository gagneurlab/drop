class Test_AE_Config:
    ...
    def test_getCountsFiles(self, demo_dir, dropConfig):
        ...
        counts_files = [
            ...
            'external_geneCounts.tsv.gz'
        ]
        counts_files_true = [f"{counts_dir}/{f}" for f in counts_files].sort()
        counts_files_test = dropConfig.AE.getCountFiles(annotation="v29", group="outrider").sort()
