...
# run the RVC module using this config_RVC_norun (which should do nothing)
    ...
    def test_variants_batch(self, demo_dir):
        vcf_file0 = f"{demo_dir}/Output/processed_results/rnaVariantCalling/batch_vcfs/batch_0/batch_0_v29.annotated.vcf.gz"
        vcf_file1 = f"{demo_dir}/Output/processed_results/rnaVariantCalling/batch_vcfs/batch_1/batch_1_v29.annotated.vcf.gz"
        r_cmd = """ 
                library(data.table)
                vcf0  <- fread("{}")
